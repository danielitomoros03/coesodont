...
ActiveRecord::Schema[7.0].define(version: 2026_06_14_184622) do
  ...
  create_table "academic_records", force: :cascade do |t|
    ...
    t.index ["enroll_academic_process_id", "course_id"], name: "index_academic_records_on_enroll_and_course", unique: true
  ...
  create_table "versions", force: :cascade do |t|
    ...
    t.string "ip"
    t.string "user_agent"
    t.index ["item_type", "item_id", "created_at"], name: "index_versions_on_item_type_item_id_created_at"
